<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectPaper.aspx.cs" Inherits="SelectPaper" %>
        ...
        <div style="z-index: 101; left: 170px; width: 100px; position: absolute; top: 80px;
           ...
           <asp:Panel ID="panelAdd" runat="server" Height="292px" Width="785px" Visible="False">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:testConnectionString %>"
                DeleteCommand="DELETE FROM [Question] WHERE [QesID] = @QesID" InsertCommand="INSERT INTO [Question] ([QesDescription], [QesKey], [QesAnswer1], [QesAnswer2], [QesAnswer3], [QesAnswer4]) VALUES (@QesDescription, @QesKey, @QesAnswer1, @QesAnswer2, @QesAnswer3, @QesAnswer4)"
                SelectCommand="SELECT * FROM [Question]" UpdateCommand="UPDATE [Question] SET [QesDescription] = @QesDescription, [QesKey] = @QesKey, [QesAnswer1] = @QesAnswer1, [QesAnswer2] = @QesAnswer2, [QesAnswer3] = @QesAnswer3, [QesAnswer4] = @QesAnswer4 WHERE [QesID] = @QesID">
                <DeleteParameters>
            ...
            试卷中已有选择题：
                ...
                SelectCommand="sp_get_qestion_of_papper" SelectCommandType="StoredProcedure">
                <SelectParameters>
