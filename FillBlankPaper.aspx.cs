...
public partial class FillBlankPaper : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        for (int index = 0; index < GridView1.Rows.Count; index++)
        {
            ...
            if (checkSelect.Checked)
            {
                ...
                objconn1.Open();
                //string h_PapID = "2";
                SqlCommand objcmd1 = new SqlCommand(" select FillBlankPapPnt from Paper where papID='" + h_PapID + "'", objconn1);
                String point1 = objcmd1.ExecuteScalar().ToString();
                string strError = myQuestion.AddFillBlankQuestionTopaper(Convert.ToInt32(Request.Cookies["papID"].Value), Convert.ToInt32(GridView1.DataKeys[index].Value.ToString()), Convert.ToInt32(point1));
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        for (int index = 0; index < GridView2.Rows.Count; index++)
        {
            ...
            if (checkSelect.Checked)
            {
                ...
                string strError = myQuestion.DelFillBlankQesFromPaper(Convert.ToInt32(Request.Cookies["papID"].Value), Convert.ToInt32(GridView2.Rows[index].Cells[2].Text.ToString()));
                //string strError = myQuestion.AddQuestionTopaper(3, 5);
                lblTest.Text = strError;
