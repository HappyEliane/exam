<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FillBlankQuestion.aspx.cs" Inherits="FillBlankQuestion" %>
...
<h3>
    ...
    <p>
        &nbsp;<asp:TextBox ID="txtDes" runat="server" Height="178px" TextMode="MultiLine" Width="537px"></asp:TextBox></p>
            <div style="z-index: 101; left: 600px; width: 100px; position: absolute; top: 180px;
                height: 100px">
        答案：<br />
        <table style="width: 358px; height: 182px">

        &nbsp;<asp:TextBox ID="txtKey" runat="server" TextMode="MultiLine" ></asp:TextBox></p>
    ...
    <p>
     ...
     <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:testConnectionString %>"
            SelectCommand="SELECT * FROM [FillBlankQuestion]" DeleteCommand="DELETE FROM [FillBlankQuestion] WHERE [FillBlankQuestionID] = @FillBlankQuestionID" InsertCommand="INSERT INTO [FillBlankQuestion] ([QesDescription], [QesKey]) VALUES (@QesDescription, @QesKey)" UpdateCommand="UPDATE [FillBlankQuestion] SET [QesDescription] = @QesDescription, [QesKey] = @QesKey WHERE [FillBlankQuestionID] = @FillBlankQuestionID">
            <DeleteParameters>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" pagesize="15" AutoGenerateColumns="False"
            ...
            <Columns>
                <asp:BoundField DataField="FillBlankQuestionID" HeaderText="试题编号 " InsertVisible="False" ReadOnly="True"
        ...
        <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="添加填空题" /></asp:Panel>
    </div>
    </form>
</body>
</html>
