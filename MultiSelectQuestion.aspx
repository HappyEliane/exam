<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MultiSelectQuestion.aspx.cs" Inherits="MultiSelectQuestion" %>
        ...
        <table style="width: 358px; height: 182px">
            ...
            <tr>
                ...
                <td style="width: 214px; height: 84px">
                        <asp:CheckBoxList ID="cblKey" runat="server" RepeatDirection="Horizontal">
    ...
    <p>
     ...
     <p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:testConnectionString %>"
            SelectCommand="SELECT * FROM [MultiSelectQuestion]" DeleteCommand="DELETE FROM [MultiSelectQuestion] WHERE [QesID] = @QesID" InsertCommand="INSERT INTO [MultiSelectQuestion] ([QesDescription], [QesKey], [QesAnswer1], [QesAnswer2], [QesAnswer3], [QesAnswer4]) VALUES (@QesDescription, @QesKey, @QesAnswer1, @QesAnswer2, @QesAnswer3, @QesAnswer4)" UpdateCommand="UPDATE [MultiSelectQuestion] SET [QesDescription] = @QesDescription, [QesKey] = @QesKey, [QesAnswer1] = @QesAnswer1, [QesAnswer2] = @QesAnswer2, [QesAnswer3] = @QesAnswer3, [QesAnswer4] = @QesAnswer4 WHERE [QesID] = @QesID">
            <DeleteParameters>
        ...
        <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="添加多选题" /></asp:Panel>
    </div>
    </form>
</body>
</html>
