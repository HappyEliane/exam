...
<div style="z-index: 101; left: 18px; width: 743px; position: absolute; top: 69px;
        height: 219px">
...
<h3>
    ...
    <asp:Label ID="Label1" runat="server"></asp:Label></h3>
        ...
        <asp:RadioButtonList ID="txtPrivilege" runat="server" Height="30px" Width="180px" RepeatDirection="Horizontal">
         ...
         <p>
        <asp:Button ID="Button2" runat="server" Text="提交" OnClick="btn_Submit_Click" />
     ...
     <p>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" pagesize="18" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="UsrID" HeaderText="ID" SortExpression="UsrID" >
        ...
        <tr>
         ...
         <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="添加老师" /></asp:Panel>
           <div style="z-index: 102; left: 1000px; width: 150px; position: absolute; top: 40px;
            height: 100px">
        <asp:Panel ID="panelSearch" runat="server" Height="207px" Width="768px" >
            ...
            <asp:Button ID="BtnSearch" runat="server" OnClick="btnSearch_Click" Text="输入ID查询" />
            </asp:Panel>
        </div>
    </div>
    </form>
