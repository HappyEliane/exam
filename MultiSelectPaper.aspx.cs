...
public partial class MultiSelectPaper : System.Web.UI.Page
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        for (int index = 0; index < GridView2.Rows.Count; index++)
        {
            ...
            if (checkSelect.Checked)
            {
                string strError = myQuestion.DelMultiSelectQesFromPaper(Convert.ToInt32(Request.Cookies["papID"].Value), Convert.ToInt32(GridView2.Rows[index].Cells[2].Text.ToString()));
                lblTest.Text = strError;
            }
        }
        GridView2.DataBind();
